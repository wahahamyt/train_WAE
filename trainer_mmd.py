...
from ops import multistep_lr_decay, mmd
from utils import DataGather
from wae64 import WAE64
from utils import data_prefetcher
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.net = WAE64(tr=True, z_dim=args.z_dim).cuda()
        ...
        self.prefetcher = data_prefetcher(self.data_loader)
